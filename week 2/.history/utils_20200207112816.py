...
if __name__ == '__main__':
    ...
    parser.add_argument("--exercise2", help="second takes a path to a folder and write all filenames recursively (files of all sub folders to).")
    parser.add_argument("--exercise3", nargs="*", help="third takes a list of filenames and print the first line of each.")
    parser.add_argument("--exercise4", help="third takes a list of filenames and print the first line of each.")
    parser.add_argument("--exercise5", nargs="*", help="fifth takes a list of md files and writes all headlines (lines starting with #) to a file Make" )
