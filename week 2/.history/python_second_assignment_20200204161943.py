...
if __name__ == '__main__':
    ...
    parser.add_argument("--exercise1", help='function that can print content of a csv file to the console')
    parser.add_argument("--exercise2", nargs="+", help='function that can take a list of tuple and write each element to a new line in file')
    parser.add_argument("--exercise3", help='function that take a csv file and read each row into a list')
