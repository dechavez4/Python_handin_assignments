...
def run():
    ...
    if args.exercise2:
        inputfield = argv[3:]
        write_list_to_file(argv[2], inputfield)    
    if args.exercise3:
        read_line(argv[2])
    if args.file:
        path.exists(argv[2])
...
if __name__ == '__main__':
    ...
    parser.add_argument("--file", help="an argument that if given will write the content to file_name or otherwise will print it to the console.")
