...
def run():
    if args.exervise_2.1:
        read_folder(argv[2], argv[3])
    if args.exervise_2.2:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--exervise_2.1", help='first function takes a path to a folder and writes all filenames in the folder to a specified output file')
    parser.add_argument("--exervise_2.2", nargs="*", help="second takes a path to a folder and write all filenames recursively (files of all sub folders to).")
    parser.add_argument("--exervise_2.3", nargs="*", help="third takes a list of filenames and print the first line of each.")
