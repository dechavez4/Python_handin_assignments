...
for k, col in zip(range(n_clusters), colors):
    ...
    print("members: ------", my_members)
    x, y = iris_data[my_members,False], iris_data[my_members,True]
    print(x,y)
    ax.scatter(x=iris_data[my_members,0], y=iris_data[my_members,1], c=col, linewidth=0.2)
